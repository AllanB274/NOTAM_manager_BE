...
INSERT INTO Notam(idNotam, typeNotam, date_declaration, date_debut, date_fin, creneau, description, limite_inferieur, limite_superieur, typeVol, idAerodrome, idUser, idObjet)
VALUES
